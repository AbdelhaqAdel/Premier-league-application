...
import 'package:premleague/Clean_arch/Features/Stats/presentation/widgets/standingListViewBuilder.dart';
...
class Stats extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => 
      //StandingTableCubit(StandingRepoImpl.getInstance())..fetchStandingTable(),
       StandingTableCubit(getIt.get<StandingRepoImpl>())..fetchStandingTable(),
      //the next line to replace getit package.... 
      // StandingTableCubit(StandingRepoImpl.getInstance()),
      child: BlocConsumer<StandingTableCubit, StandingTableState>(
        listener: (context, state) {},
        builder: (context, state) {
          //StandingTableCubit standingCubit=StandingTableCubit(getIt.get<StandingRepoImpl>());
                          ...
                          children: [
                            Expanded(
                              child: GestureDetector(
                                onTap: () {
                                  Navigator.pushNamed(context, Routes.scorer
                            ...
                            Expanded(
                              child: GestureDetector(
                                onTap: () {
                                  ...
                                  Navigator.pushNamed(context, Routes.assist);
                                },
                                child: Container(
                                  decoration: BoxDecoration(
                                    color: HexColor('#570861'),
